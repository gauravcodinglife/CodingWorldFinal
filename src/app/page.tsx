...
const testimonials = [
  {
    quote: "Terminal labs feel real.",
    feedback: "I finally understood Docker basics without breaking my system.",
    author: "- Amit",
  },
  {
    quote: "Tracks are well structured.",
    feedback: "The roadmap helped me know what to learn next.",
    author: "- Anjali",
  },
  {
    quote: "Great for interview prep.",
    feedback: "CLI practice + scenarios made concepts stick.",
    author: "- Tirth",
  },
];
    ...
    <div className="bg-card/60 p-4 rounded-xl shadow-2xl border border-white/10 backdrop-blur-sm shadow-cyan-500/10">
      ...
      <section id="testimonials" className="container mx-auto px-4 py-12">
        <div className="text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 font-headline">Loved by Learners</h2>
          <p className="text-muted text-lg md:text-xl max-w-2xl mx-auto">
            Real feedback from people practicing cloud the hands-on way.
          </p>
        </div>

        <div className="grid grid-cols-2 gap-8 my-12 max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial) => (
            <Card key={testimonial.quote} className="bg-card/60 border-white/10">
              <CardContent className="p-6">
                <blockquote className="text-lg font-semibold mb-2">"{testimonial.quote}"</blockquote>
                <p className="text-muted mb-4">{testimonial.feedback}</p>
                <footer className="text-sm font-medium text-cyan">{testimonial.author}</footer>
              </CardContent>
            </Card>
          ))}
        </div>
